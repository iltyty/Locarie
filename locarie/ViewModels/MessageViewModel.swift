  ...
  func loadLocalCachedMessages(receiver _: User) -> [User: [Message]] {
    [
      User.business1: [
        Message(
          sender: User.user1,
          receiver: User.business1,
          content: "Hello, I'm \(User.user1.username)"
        ),
        Message(
          sender: User.user1,
          receiver: User.business1,
          content: "I wanna order a toasted bread"
        ),
        Message(
          sender: User.user1,
          receiver: User.business1,
          content: "Is it possible to have it delivered to my house at 7 p.m. tonight?"
        ),
        Message(
          sender: User.business1,
          receiver: User.user1,
          content: "Hello, no problem. May I ask what flavor you would like?"
        ),
        Message(
          sender: User.business1,
          receiver: User.user1,
        ...
        Message(
          sender: User.user1,
          receiver: User.business1,
          content: "I would like the blueberry flavor, please"
        ),
        Message(
          sender: User.business1,
          receiver: User.user1,
